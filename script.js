    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                // Simulate submission - replace with actual fetch call
                setTimeout(function() {
        ...
        contactForm.addEventListener('input', function(e) {
            if (e.target.matches('input, textarea, select')) {
                const existing = e.target.parentElement.querySelector('.error-message');
                if (existing) existing.remove();
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f6fce536-2ab4-45aa-960f-6d1575daaf5f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f6fce536-2ab4-45aa-960f-6d1575daaf5f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f6fce536-2ab4-45aa-960f-6d1575daaf5f';
